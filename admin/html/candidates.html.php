...
<html lang="pl">
    ...
    document.getElementById('helpCloud').style.display = 'none';
        ...
        <div id="helpCloud" style="display: none">
            Wybierz swojego kandydata, a następnie kliknij przycisk głosuj. Jeżeli nie chcesz głosować 
				to zaznacz pusty głos. Niewybranie żadnego kandydata jest równoważne oddaniu pustego głosu!
        </div>
        <div  id="title" style="display: none">
            Wybory do samorządu 2015
        </div>
		<div class="top" id="instruction">
                    Wybierz swojego kandydata, a następnie kliknij przycisk głosuj. Jeżeli nie chcesz głosować to zaznacz pusty głos. Niewybranie żadnego kandydata jest równoważne oddaniu pustego głosu!
		</div>
